...
3. Continue the story. Press a decision, or type what should happen next. The request is queued and the activity page shows the agent writing, with its live text and the tools it uses; when the chapter is finished the page reloads the book.
