 ...
 *     different one;
 *   - verifies every declared file's byte count, SHA-256 and UTF-8 encoding;
 *   - rejects a missing manifest, an unknown `schema_version`, a duplicate `path`, a
 *     duplicate `artifact_id`, an undeclared `role`, an absolute or `..` path and a
 *     symlink escape, resolving real paths rather than comparing strings;
