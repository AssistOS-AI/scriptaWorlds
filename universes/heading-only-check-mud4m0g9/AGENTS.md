# Universe "heading-only-check-mud4m0g9" — instructions for the ALA agent

- Fundamental law of this universe (inviolable): This book was imported from a file the team uploaded: the text is the law, and canon records what it establishes.
- Ingredients of this world:
- (none chosen: the world still has to say which operations it is built from)
- Fiction language: **Română (ro)**. Write all narrative text in this language; keep the
