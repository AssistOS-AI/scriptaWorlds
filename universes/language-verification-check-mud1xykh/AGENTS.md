# Universe "Language verification check-mud1xykh" — instructions for the ALA agent

- Fundamental law of this universe (inviolable): Every act of attention dims a star somewhere; the sky remembers who looked.
- Ingredients of this world:
- (none chosen: the world still has to say which operations it is built from)
- Fiction language: **Français (fr)**. Write all narrative text in this language; keep the
